...
const create = async (req, res) => {
    if (!req.body) req.body = {}; // NEW: handle empty requests

  const { error, value } = taskSchema.validate(req.body, { abortEarly: false }); // NEW: validate

  if (error) { // NEW: return if invalid
